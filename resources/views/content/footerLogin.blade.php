              ...
              <div class="container">
                <div class="row">
                  <div class="col l12 s12 center">
                      ...
                      <p class="white-text"><a href="" class="link-footer">SINAU OFFLINE</a> - <a href="{{route('faq_log')}}" class="link-footer">FAQ</a>  - <a href="" class="link-footer">SINAU ONNLINE</a> - <a href="" class="link-footer">PERATURAN</a></p>
                  </div>
                  <div class="col l12 s12 center">
