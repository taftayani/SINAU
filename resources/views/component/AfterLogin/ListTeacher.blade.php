...
<div class="row"> 
        <div class="col xl12">
          <h1 class="center header-profile-second">Daftar Katagori Pengajar Teknologi dan Science</h1>
        </div>
    </div>
    <div class="row">
       @foreach ($teacher as $teachers)
...
<div class="row"> 
        <div class="col xl12">
          <h1 class="center header-profile-second">Daftar Katagori Pengajar Sosial dan Enterpreneur </h1>
        </div>
    </div>
    <div class="row">
       @foreach ($teacher as $teachers)
